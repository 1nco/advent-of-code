...
//                }
            ...
            var minlocation = getDestinationFromSource(humidityToLocationMap, getDestinationFromSource(temperatureToHumidityMap, getDestinationFromSource(lightToTemperatureMap, getDestinationFromSource(waterToLightMap, getDestinationFromSource(fertilizerToWaterMap, getDestinationFromSource(soilToFertilizerMap, getDestinationFromSource(seedToSoilMap, seeds[0].toLong())))))));

            seeds.forEach{seed ->

                if (getDestinationFromSource(humidityToLocationMap, getDestinationFromSource(temperatureToHumidityMap, getDestinationFromSource(lightToTemperatureMap, getDestinationFromSource(waterToLightMap, getDestinationFromSource(fertilizerToWaterMap, getDestinationFromSource(soilToFertilizerMap, getDestinationFromSource(seedToSoilMap, seed.toLong()))))))) < minlocation) {
                    minlocation = getDestinationFromSource(humidityToLocationMap, getDestinationFromSource(temperatureToHumidityMap, getDestinationFromSource(lightToTemperatureMap, getDestinationFromSource(waterToLightMap, getDestinationFromSource(fertilizerToWaterMap, getDestinationFromSource(soilToFertilizerMap, getDestinationFromSource(seedToSoilMap, seed.toLong())))))));
                }
            ...
            var minLocationSecond = getDestinationFromSource(humidityToLocationMap, getDestinationFromSource(temperatureToHumidityMap, getDestinationFromSource(lightToTemperatureMap, getDestinationFromSource(waterToLightMap, getDestinationFromSource(fertilizerToWaterMap, getDestinationFromSource(soilToFertilizerMap, getDestinationFromSource(seedToSoilMap, seeds[0].toLong())))))));
            ...
            seeds.forEach{seed ->
                if (seedNum % 2 == 0) {
                    ...
                    while (i < range) {
                        ...
                        if (getDestinationFromSource(humidityToLocationMap, getDestinationFromSource(temperatureToHumidityMap, getDestinationFromSource(lightToTemperatureMap, getDestinationFromSource(waterToLightMap, getDestinationFromSource(fertilizerToWaterMap, getDestinationFromSource(soilToFertilizerMap, getDestinationFromSource(seedToSoilMap, seed + i))))))) < minLocationSecond) {
                            minLocationSecond = getDestinationFromSource(humidityToLocationMap, getDestinationFromSource(temperatureToHumidityMap, getDestinationFromSource(lightToTemperatureMap, getDestinationFromSource(waterToLightMap, getDestinationFromSource(fertilizerToWaterMap, getDestinationFromSource(soilToFertilizerMap, getDestinationFromSource(seedToSoilMap, seed + i)))))));
                        }
                        i++
                        million++;
                    }
